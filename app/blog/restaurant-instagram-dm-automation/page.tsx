  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        ...
        description='Empty tables on Tuesday nights? Learn how restaurants are using Instagram DM automation to fill slow periods, push specials, and increase reservations without p'
      ...
      <main className='flex-1'>
        <BlogJsonLd
          title='Restaurant Instagram DM Automation: Fill Tables and Increase Reservations on Autopilot'
          description='Empty tables on Tuesday nights? Learn how restaurants are using Instagram DM automation to fill slow periods, push specials, and increase reservations without paid ads.'
          slug='restaurant-instagram-dm-automation'
          date='2026-03-07'
          category='Local Business'
        />
