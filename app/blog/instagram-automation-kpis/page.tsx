...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='The 5 Instagram Automation KPIs That Actually Matter (And How to Track Them)'
        description='Follower count is a vanity metric. These 5 Instagram automation KPIs reveal whether your DM system is actually generating revenue — and how to improve each one.'
