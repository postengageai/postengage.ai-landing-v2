...
export const metadata: Metadata = {
  title: 'Selling Online Courses via Instagram DM Automation: The Complete Sales System | PostEngage Blog',
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Selling Online Courses via Instagram DM Automation: The Complete Sales System</h1>
              <p className="text-xl text-gray-600 mb-6">Course creators who use Instagram DM automation for sales consistently outperform those relying on link-in-bio and email alone.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="Selling Online Courses via Instagram DM Automation: The Complete Sales System" /></div>
            </aside>
          </div>
        </div>
      </main>
