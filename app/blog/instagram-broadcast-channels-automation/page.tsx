...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='Instagram Broadcast Channels + DM Automation: The 1-2 Punch Nobody'
        description='Instagram Broadcast Channels have 10x the reach of feed posts. Combine them with DM automation and you have the most powerful engagement system on any platform.'
      ...
      <main className='flex-1'>
        ...
        <article className='container mx-auto max-w-7xl px-4 py-12 md:py-24'>
          ...
          <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border shadow-sm'>
            <Image
              src='/blog/broadcast-channels-cover.png'
              alt='Instagram Broadcast Channels Automation'
              fill
