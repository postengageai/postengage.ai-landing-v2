  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        ...
        description='Your Instagram following is rented land. Learn how to convert followers into email subscribers using DM automation — and own your audience forever.'
      ...
      <main className='flex-1'>
        ...
        <article className='container mx-auto max-w-7xl px-4 py-12 md:py-24'>
          ...
          <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border shadow-sm'>
            <Image
              src='/blog/email-list-cover.png'
              alt='Instagram Email List Building'
              fill
