          ...
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
            <aside className='hidden lg:col-span-3 lg:block'>
              <div className='sticky top-32 space-y-8'>
                <TableOfContents items={[{ id: 'lead-challenge', title: 'The Lead Challenge' }, { id: 'instagram-mortgage', title: 'Instagram for Brokers' }, { id: 'automation-system', title: 'Automation System' }, { id: 'qualification-funnel', title: 'Qualification Funnel' }, { id: 'broker-growth', title: 'Growth Results' }]} />
