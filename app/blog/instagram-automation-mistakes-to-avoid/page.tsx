...
export const metadata: Metadata = {
  ...
  description: 'Most brands doing Instagram automation are doing it wrong. Here are the seven most damaging mistakes and exactly how to fix each one.',
  openGraph: {
    title: '7 Instagram Automation Mistakes That Tank Your Engagement (And How to Fix Them)',
    description: 'Most brands doing Instagram automation are doing it wrong. Here are the seven most damaging mistakes and exactly how to fix each one.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-automation-mistakes-to-avoid',
    images: [{ url: '/blog/instagram-automation-mistakes-to-avoid-cover.png', width: 1200, height: 630, alt: '7 Instagram Automation Mistakes That Tank Your Engagement (And How to Fix Them)' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: '7 Instagram Automation Mistakes That Tank Your Engagement (And How to Fix Them)',
    description: 'Most brands doing Instagram automation are doing it wrong. Here are the seven most damaging mistakes and exactly how to fix each one.',
    images: ['/blog/instagram-automation-mistakes-to-avoid-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  7 Instagram Automation Mistakes That Tank Your Engagement (And How to Fix Them)
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Most brands doing Instagram automation are doing it wrong. Here are the seven most damaging mistakes and exactly how to fix each one. This guide covers everything you need to know to get started and see results quickly.
              </div>
