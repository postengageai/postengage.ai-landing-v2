...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='The End of'
        description='We are partnering with RecentReborn to solve the biggest problem in 2026: The Discovery Deficit. Learn how to turn visibility into viral engagement.'
