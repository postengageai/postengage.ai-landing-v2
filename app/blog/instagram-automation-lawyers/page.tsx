...
import { ArrowLeft, Shield, Briefcase, Users, CheckCircle2, DollarSign } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  description: 'Instagram is an untapped channel for law firms. Here\'s how to generate qualified client inquiries while staying bar-compliant.',
  openGraph: {
    title: 'Law Firms on Instagram: How to Generate Client Inquiries With DM Automation (Ethically)',
    description: 'Instagram is an untapped channel for law firms. Here\'s how to generate qualified client inquiries while staying bar-compliant.',
  ...
  twitter: {
    ...
    title: 'Law Firms on Instagram: Ethical Client Generation Through DM Automation',
    description: 'How law firms generate qualified client inquiries through Instagram while staying bar-compliant',
...
export default function BlogPostPage() {
  const jsonLd = {
    ...
    '@type': 'BlogPosting',
    headline: 'Law Firms on Instagram: How to Generate Client Inquiries With DM Automation (Ethically)',
      ...
      <main className='flex-1 pt-32 pb-24'>
        <article className='mx-auto max-w-5xl px-4 sm:px-6 lg:px-8'>
          <div className='mb-12 flex items-center justify-between'>
            ...
            <SocialShareButtons title='Law Firms on Instagram: How to Generate Client Inquiries With DM Automation (Ethically)' url='https://postengage.ai/blog/instagram-automation-lawyers' />
          </div>
          <header className='mx-auto mb-12 max-w-4xl text-center'>
            <div className='mb-8 flex flex-wrap items-center justify-center gap-3'>
              <Badge variant='default' className='bg-primary/10 text-primary hover:bg-primary/20 px-3 py-1 text-sm font-medium border-none'>Legal</Badge>
            ...
            <h1 className='mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl bg-gradient-to-r from-foreground via-foreground/90 to-muted-foreground bg-clip-text text-transparent'>Law Firms on Instagram: How to Generate Client Inquiries With DM Automation (Ethically)</h1>
            <p className='mx-auto max-w-2xl text-xl text-muted-foreground leading-relaxed'>Instagram is an untapped channel for law firms. Here's how to generate qualified client inquiries while staying bar-compliant.</p>
          </header>
          <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border bg-muted/30 shadow-sm'>
            <div className='absolute inset-0 flex items-center justify-center bg-gradient-to-br from-primary/5 via-transparent to-primary/5'>
              <span className='text-muted-foreground/20 font-medium'>Law firms generating ethical client inquiries through Instagram automation</span>
            </div>
          </div>
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
            <aside className='hidden lg:col-span-3 lg:block'>
              <div className='sticky top-32 space-y-8'>
                <TableOfContents items={[
                  { id: 'legal-instagram-opportunity', title: 'Why Law Firms Should Be on Instagram' },
                  { id: 'bar-compliance-automation', title: 'Bar Compliance & Automation' },
                  { id: 'ethical-client-intake', title: 'Ethical Client Intake Automation' },
                  { id: 'practice-area-specialization', title: 'Practice-Area Specific Automation' },
                  { id: 'legal-best-practices', title: 'Best Practices for Law Firms' }
                ]} />
            ...
            <div className='lg:col-span-9'>
              <div className='prose prose-lg prose-neutral dark:prose-invert max-w-none'>
                <h2 id='legal-instagram-opportunity' className='scroll-mt-24'>Why Law Firms Should Be on Instagram</h2>
                <p>
                ...
                <Card className='my-8 border-primary/20 bg-primary/5'>
                  ...
                  <CardContent className='space-y-3'>
                    <div className='flex gap-4'>
                      ...
                      <p className='text-sm text-muted-foreground'>of people seeking legal services research attorneys on social media first</p>
                    </div>
                    <div className='flex gap-4'>
                      <div className='font-semibold text-primary'>48%</div>
                      <p className='text-sm text-muted-foreground'>have contacted a law firm via social media DM about legal representation</p>
                    </div>
                    <div className='flex gap-4'>
                      <div className='font-semibold text-primary'>2.1x</div>
                      <p className='text-sm text-muted-foreground'>higher engagement for legal content addressing common client questions vs. firm promotion</p>
                    </div>
                  </CardContent>
                </Card>

                <h2 id='bar-compliance-automation' className='scroll-mt-24'>Bar Compliance & Automation</h2>
                <p>
                ...
                <ul>
                  <li>Communications don't create attorney-client relationships unintentionally</li>
                  <li>Responses are accurate and don't constitute legal advice</li>
                  <li>Marketing complies with solicitation rules</li>
                  <li>Confidentiality is maintained (Instagram DMs aren't encrypted)</li>
                  <li>Clear identification that communication is from the law firm</li>
                </ul>
                <Card className='my-6 border-yellow-500/20 bg-yellow-500/5'>
                  <CardHeader>
                    <CardTitle className='text-base'>Critical Compliance Note</CardTitle>
                  </CardHeader>
                  <CardContent className='text-sm space-y-2'>
                    <p className='font-medium'>Before implementing DM automation, your firm should:</p>
                    <ul className='space-y-1 ml-4'>
                      <li>• Consult your state bar rules on social media solicitation</li>
                      <li>• Review your malpractice insurance for social media liability</li>
                      <li>• Have your automation responses reviewed by a compliance officer</li>
                      <li>• Include required disclaimers in all automated responses</li>
                      <li>• Maintain records of all DM communications</li>
                    </ul>
                  </CardContent>
                </Card>

                <h2 id='ethical-client-intake' className='scroll-mt-24'>Ethical Client Intake Automation</h2>
                <p>
                ...
                <Card className='my-6 border-blue-500/20 bg-blue-500/5'>
                  <CardContent className='pt-6 space-y-4'>
                    <div>
                      <p className='font-medium text-sm mb-2'>Message 1 (Instant - With Disclaimer):</p>
                      <p className='text-xs text-muted-foreground'>"Thank you for contacting [Law Firm]. IMPORTANT: This is not legal advice. Responding to this message does not create an attorney-client relationship. We look forward to discussing your legal matter. To protect confidentiality, please do not include sensitive information in DMs. Could you share: 1) Practice area (divorce, employment, etc), 2) Timing (urgent or can wait), 3) Location?"</p>
                    </div>
                    <div>
                      <p className='font-medium text-sm mb-2'>Message 2 (After they respond):</p>
                      <p className='text-xs text-muted-foreground'>Based on their info: "Thank you for providing those details. We handle [practice area] cases. Our typical consultation fee is $[X]. Let's schedule a confidential consultation where we can properly assess your situation. [Calendar link]"</p>
                    </div>
                    <div>
                      <p className='font-medium text-sm mb-2'>Message 3 (After booking):</p>
                      <p className='text-xs text-muted-foreground'>"Your consultation is confirmed for [date/time]. Please don't share sensitive case details via DM for confidentiality. We'll discuss everything thoroughly during our call. [Zoom link or location]"</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className='my-8 border-green-500/20 bg-green-500/5'>
                  <CardHeader>
                    <CardTitle className='text-base'>Case Study: Miller & Associates (Divorce Practice)</CardTitle>
                  </CardHeader>
                  <CardContent className='space-y-2 text-sm'>
                    <p><span className='font-semibold text-green-600'>62 new divorce clients</span> from Instagram DM automation (6-month period)</p>
                    <p><span className='font-semibold text-green-600'>$412,000</span> in engagement fees from Instagram-sourced clients</p>
                    <p><span className='font-semibold'>Challenge:</span> Law firm wasn't generating new divorce leads; existing referral network was declining</p>
                    <p><span className='font-semibold'>Solution:</span> Launched Instagram content about divorce misconceptions. Used compliant automation for inquiries. Every automated response included bar-approved disclaimers.</p>
                  </CardContent>
                </Card>

                <h2 id='practice-area-specialization' className='scroll-mt-24'>Practice-Area Specific Automation</h2>
                <p>
                ...
                <h2 id='legal-best-practices' className='scroll-mt-24'>Best Practices for Law Firms</h2>
                ...
                <div className='mt-12 rounded-xl bg-muted/50 p-6'>
                  <h3 className='text-lg font-semibold mb-2'>Ready to generate qualified client inquiries ethically?</h3>
                  <p className='text-muted-foreground mb-4'>Try PostEngage.ai free for 14 days — no credit card required. Respond to every client inquiry instantly while maintaining bar compliance.</p>
              ...
              <div className='mt-16 border-t pt-8'>
                <div className='flex items-center gap-4'>
                  ...
                  <div><div className='font-semibold'>Emma Clarke</div><div className='text-sm text-muted-foreground'>Legal Practice Growth Expert</div></div>
                </div>
              </div>
            </div>
          </div>
