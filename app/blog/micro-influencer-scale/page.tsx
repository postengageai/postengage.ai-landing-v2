...
import { ArrowLeft, Users, BarChart2, Handshake } from 'lucide-react';
...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='Micro-Influencer Scale: Automating Outreach Without Losing Soul'
        description='How to scale your influencer marketing program from 10 to 1,000 partners using intelligent automation and personalized outreach.'
