          ...
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
            <aside className='hidden lg:col-span-3 lg:block'>
              <div className='sticky top-32 space-y-8'>
                <TableOfContents items={[{ id: 'travel-challenge', title: 'The Agency Challenge' }, { id: 'instagram-travel', title: 'Instagram for Travel' }, { id: 'automation-framework', title: 'Automation Framework' }, { id: 'qualification-booking', title: 'Smart Qualification' }, { id: 'growth-results', title: 'Growth Results' }]} />
