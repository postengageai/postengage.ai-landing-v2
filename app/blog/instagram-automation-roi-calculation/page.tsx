...
export const metadata: Metadata = {
  title: 'How to Calculate the ROI of Your Instagram DM Automation | PostEngage Blog',
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">How to Calculate the ROI of Your Instagram DM Automation</h1>
              <p className="text-xl text-gray-600 mb-6">If you cannot measure it, you cannot improve it. Here is the exact formula for calculating ROI from Instagram DM automation.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="How to Calculate the ROI of Your Instagram DM Automation" /></div>
            </aside>
          </div>
        </div>
      </main>
