...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='Getting Started with PostEngage.ai: Your First Week Setup Guide'
        description='New to PostEngage.ai? This step-by-step first-week guide will have you automating Instagram DMs and comments in under 30 minutes — no technical experience neede'
      ...
      <main className='flex-1'>
        <BlogJsonLd
          title='Getting Started with PostEngage.ai: Your First Week Setup Guide'
          description='New to PostEngage.ai? This step-by-step first-week guide will have you automating Instagram DMs and comments in under 30 minutes — no technical experience needed.'
          slug='getting-started-postengage-guide'
          date='2026-03-08'
          category='Tutorial'
        />
