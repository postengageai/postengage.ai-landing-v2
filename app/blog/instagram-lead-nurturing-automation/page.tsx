...
export const metadata: Metadata = {
  ...
  description: 'Not every lead buys immediately. Learn how to build a multi-touch DM nurture sequence that stays top of mind for weeks without manual follow-up.',
  openGraph: {
    title: 'Instagram Lead Nurturing: How to Keep Cold Leads Warm Automatically',
    description: 'Not every lead buys immediately. Learn how to build a multi-touch DM nurture sequence that stays top of mind for weeks without manual follow-up.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-lead-nurturing-automation',
    images: [{ url: '/blog/instagram-lead-nurturing-automation-cover.png', width: 1200, height: 630, alt: 'Instagram Lead Nurturing: How to Keep Cold Leads Warm Automatically' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Instagram Lead Nurturing: How to Keep Cold Leads Warm Automatically',
    description: 'Not every lead buys immediately. Learn how to build a multi-touch DM nurture sequence that stays top of mind for weeks without manual follow-up.',
    images: ['/blog/instagram-lead-nurturing-automation-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Instagram Lead Nurturing: How to Keep Cold Leads Warm Automatically
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Not every lead buys immediately. Learn how to build a multi-touch DM nurture sequence that stays top of mind for weeks without manual follow-up. This guide covers everything you need to know to get started and see results quickly.
              </div>
