...
export const metadata: Metadata = {
  ...
  description: 'Course creators who use Instagram DM automation report 3x higher enrollment rates. Here is the exact flow from first comment to completed checkout.',
  openGraph: {
    title: 'Selling Online Courses with Instagram DM Automation: The 2026 Playbook',
    description: 'Course creators who use Instagram DM automation report 3x higher enrollment rates. Here is the exact flow from first comment to completed checkout.',
    type: 'article',
    url: 'https://postengage.ai/blog/sell-online-courses-instagram-dms',
    images: [{ url: '/blog/sell-online-courses-instagram-dms-cover.png', width: 1200, height: 630, alt: 'Selling Online Courses with Instagram DM Automation: The 2026 Playbook' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Selling Online Courses with Instagram DM Automation: The 2026 Playbook',
    description: 'Course creators who use Instagram DM automation report 3x higher enrollment rates. Here is the exact flow from first comment to completed checkout.',
    images: ['/blog/sell-online-courses-instagram-dms-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Selling Online Courses with Instagram DM Automation: The 2026 Playbook
                </h1>
              ...
              <div className='relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-12 bg-muted'>
                <div className='absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white'>
                  <div className='text-center p-8'>
                    ...
                    <p className='text-xl font-medium text-white/80'>Education</p>
                  </div>
                </div>
              </div>

              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Course creators who use Instagram DM automation report 3x higher enrollment rates. Here is the exact flow from first comment to completed checkout. This guide covers everything you need to know to get started and see results quickly.
              </div>
              ...
              >
                Why Education on Instagram Matters in 2026
              </h2>
              <p>Instagram has over 2 billion monthly active users, and direct engagement through DMs and comments has never been higher. For education professionals and businesses, the platform represents an unmatched opportunity to reach qualified prospects where they are already spending time.</p>
