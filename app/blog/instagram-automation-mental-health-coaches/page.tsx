  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        ...
        description='Learn how mental health coaches use Instagram DM automation responsibly and ethically to reach more clients while maintaining professional boundaries and care s'
        slug='instagram-automation-mental-health-coaches'
        datePublished='2026-03-08T09:00:00.000Z'
