...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='The Algorithmic Shift: Why'
        description='The Instagram algorithm has changed. Vanity metrics are out. Retention metrics are in. Learn how to optimize for Saves and Shares.'
