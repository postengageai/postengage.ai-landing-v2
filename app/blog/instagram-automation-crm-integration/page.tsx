...
export const metadata: Metadata = {
  title: 'Integrating Instagram DM Automation With Your CRM: A Complete Guide | PostEngage Blog',
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Integrating Instagram DM Automation With Your CRM: A Complete Guide</h1>
              <p className="text-xl text-gray-600 mb-6">Instagram DM automation becomes 10x more powerful when it flows directly into your CRM. Here is how to connect the two.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="Integrating Instagram DM Automation With Your CRM: A Complete Guide" /></div>
            </aside>
          </div>
        </div>
      </main>
