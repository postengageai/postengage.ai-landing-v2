...
export default function BlogPage() {
  const posts = [
    ...
    },
    {
      slug: 'postengage-vs-manychat-2026',
      title:
        'PostEngage vs ManyChat: Which Instagram Automation Tool Wins in 2026?',
      excerpt:
    ...
    },
    {
      slug: 'instagram-broadcast-channels-automation',
      title:
        'Instagram Broadcast Channels + DM Automation: The 2026 Power Combo',
      excerpt:
    ...
    },
    {
      slug: 'instagram-shopping-dm-automation',
      title:
        'Instagram Shopping + DM Automation: The Future of Social Commerce',
      excerpt:
