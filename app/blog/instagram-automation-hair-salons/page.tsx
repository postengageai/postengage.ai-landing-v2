          ...
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
            <aside className='hidden lg:col-span-3 lg:block'>
              <div className='sticky top-32 space-y-8'>
                <TableOfContents items={[{ id: 'booking-challenge', title: 'The Booking Challenge' }, { id: 'instagram-discovery', title: 'Instagram Discovery Path' }, { id: 'automation-system', title: 'DM Automation System' }, { id: 'booking-flow', title: 'Booking Optimization' }, { id: 'retention-revenue', title: 'Retention & Revenue' }]} />
