...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='Instagram Affiliate DM Automation Guide'
        description='Stop putting affiliate links in your bio. Here is how Instagram DM automation creates a passive commission engine that earns while you sleep.'
