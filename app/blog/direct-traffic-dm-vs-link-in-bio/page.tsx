...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background font-sans antialiased'>
      <ArticleJsonLd
        title='The'
        description='Stop asking followers to leave their feed. Use DM automation to send direct links and increase click-through rates by 300%.'
        slug='direct-traffic-dm-vs-link-in-bio'
        datePublished='2026-03-24'
        category='Blog'
      />
