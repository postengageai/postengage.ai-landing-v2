...
export const metadata: Metadata = {
  ...
  description: 'The comments section is where discovery happens. The DMs are where sales close. Learn how to craft post captions and comment CTAs that funnel people into purchase conversations.',
  openGraph: {
    title: 'The Perfect Instagram Comment Strategy for Maximum DM Conversions',
    description: 'The comments section is where discovery happens. The DMs are where sales close. Learn how to craft post captions and comment CTAs that funnel people into purchase conversations.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-comment-strategy-dm-conversions',
    images: [{ url: '/blog/instagram-comment-strategy-dm-conversions-cover.png', width: 1200, height: 630, alt: 'The Perfect Instagram Comment Strategy for Maximum DM Conversions' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'The Perfect Instagram Comment Strategy for Maximum DM Conversions',
    description: 'The comments section is where discovery happens. The DMs are where sales close. Learn how to craft post captions and comment CTAs that funnel people into purchase conversations.',
    images: ['/blog/instagram-comment-strategy-dm-conversions-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  The Perfect Instagram Comment Strategy for Maximum DM Conversions
                </h1>
              ...
              <div className='relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-12 bg-muted'>
                <div className='absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white'>
                  <div className='text-center p-8'>
                    ...
                    <p className='text-xl font-medium text-white/80'>Content Strategy</p>
                  </div>
                </div>
              </div>

              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                The comments section is where discovery happens. The DMs are where sales close. Learn how to craft post captions and comment CTAs that funnel people into purchase conversations. This guide covers everything you need to know to get started and see results quickly.
              </div>
              ...
              >
                Why Content Strategy on Instagram Matters in 2026
              </h2>
              <p>Instagram has over 2 billion monthly active users, and direct engagement through DMs and comments has never been higher. For content strategy professionals and businesses, the platform represents an unmatched opportunity to reach qualified prospects where they are already spending time.</p>
