...
export const metadata: Metadata = {
  ...
  description: 'AI replies that sound off-brand kill trust. Here is how to train your Instagram AI bot with your tone, vocabulary, and personality so it sounds like you.',
  openGraph: {
    title: 'How to Keep Your Brand Voice Consistent When Using AI Automation',
    description: 'AI replies that sound off-brand kill trust. Here is how to train your Instagram AI bot with your tone, vocabulary, and personality so it sounds like you.',
    type: 'article',
    url: 'https://postengage.ai/blog/brand-voice-ai-instagram',
    images: [{ url: '/blog/brand-voice-ai-instagram-cover.png', width: 1200, height: 630, alt: 'How to Keep Your Brand Voice Consistent When Using AI Automation' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How to Keep Your Brand Voice Consistent When Using AI Automation',
    description: 'AI replies that sound off-brand kill trust. Here is how to train your Instagram AI bot with your tone, vocabulary, and personality so it sounds like you.',
    images: ['/blog/brand-voice-ai-instagram-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  How to Keep Your Brand Voice Consistent When Using AI Automation
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                AI replies that sound off-brand kill trust. Here is how to train your Instagram AI bot with your tone, vocabulary, and personality so it sounds like you. This guide covers everything you need to know to get started and see results quickly.
              </div>
