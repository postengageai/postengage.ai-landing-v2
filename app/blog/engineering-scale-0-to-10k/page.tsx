...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='From 0 to 10k Followers: The Engineering Behind Scale'
        description='How we built a system capable of handling millions of webhook events per second without crashing. A deep dive into our serverless architecture.'
