...
export const metadata: Metadata = {
  ...
  description: 'Comment "PODCAST" to get the link in your DMs — sound familiar? Learn the comment-to-DM strategy top podcasters use to grow their listener base.',
  openGraph: {
    title: 'Growing Your Podcast with Instagram DM Automation',
    description: 'Comment "PODCAST" to get the link in your DMs — sound familiar? Learn the comment-to-DM strategy top podcasters use to grow their listener base.',
    type: 'article',
    url: 'https://postengage.ai/blog/grow-podcast-instagram-dm-automation',
    images: [{ url: '/blog/grow-podcast-instagram-dm-automation-cover.png', width: 1200, height: 630, alt: 'Growing Your Podcast with Instagram DM Automation' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Growing Your Podcast with Instagram DM Automation',
    description: 'Comment "PODCAST" to get the link in your DMs — sound familiar? Learn the comment-to-DM strategy top podcasters use to grow their listener base.',
    images: ['/blog/grow-podcast-instagram-dm-automation-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Growing Your Podcast with Instagram DM Automation
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Comment "PODCAST" to get the link in your DMs — sound familiar? Learn the comment-to-DM strategy top podcasters use to grow their listener base. This guide covers everything you need to know to get started and see results quickly.
              </div>
