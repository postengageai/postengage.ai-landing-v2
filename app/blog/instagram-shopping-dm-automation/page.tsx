...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='Instagram Shopping + DM Automation: The $0 Ads Sales Machine'
        description='Stop paying for Instagram ads when your existing followers are ready to buy. Combine Instagram Shopping tags with DM automation to sell 24/7 without ad spend.'
      ...
      <main className='flex-1'>
        ...
        <article className='container mx-auto max-w-7xl px-4 py-12 md:py-24'>
          ...
          <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border shadow-sm'>
            <Image
              src='/blog/shopping-dm-cover.png'
              alt='Instagram Shopping Dm Automation'
              fill
