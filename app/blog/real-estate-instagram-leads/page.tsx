...
import { ArrowLeft, Home, Clock, CheckCircle2 } from 'lucide-react';
...
export default function BlogPost() {
  ...
  const tableOfContents = [
    ...
    { id: 'listing-automation', title: 'Automating Listing Inquiries' },
    {
      ...
      title: 'The 3-Question Qualification Script',
    },
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='Real Estate Lead Gen 2026: Automate Your Instagram DMs'
        description='Speed to lead is everything. Learn how top agents are using Instagram automation to qualify buyers and book showings 24/7.'
        ...
        <article className='container mx-auto max-w-7xl px-4 py-12 md:py-24'>
          ...
          <header className='mx-auto mb-8 max-w-3xl'>
            ...
            <p className='mx-auto max-w-2xl text-xl text-muted-foreground leading-relaxed'>
              ...
              Discover the system that top agents use to book 10+ showings a
              week on autopilot.
            </p>
          </header>
          ...
          <div className='grid grid-cols-1 gap-12 lg:grid-cols-12'>
            ...
            <div className='lg:col-span-9 xl:col-span-8'>
              <div className='prose prose-lg dark:prose-invert max-w-none'>
                {/* Introduction */}
                <p>
                  In real estate, if you don't reply in 5 minutes, you lose the
                  lead. But you can't be on your phone 24/7. You have closings,
                  inspections, and a life.
                </p>
                <p>
                  That is why smart agents are using{' '}
                  <strong>Instagram DM Automation</strong> to qualify buyers
                  instantly, even while they are asleep.
                </p>
                  ...
                  <div className='flex items-start p-4 bg-muted/50 border rounded-lg'>
                    ...
                    <div>
                      ...
                      <div className='text-sm text-muted-foreground mt-1'>
                        ...
                        <br />
                        <strong>Result:</strong> They already booked with
                        another agent.
                      </div>
                    </div>
                  </div>
                  <div className='flex items-start p-4 bg-primary/10 border border-primary/20 rounded-lg'>
                    ...
                    <div>
                      ...
                      <div className='text-sm text-muted-foreground mt-1'>
                        ...
                        <br />
                        <strong>Result:</strong> You wake up to a new
                        appointment.
                      </div>
                    </div>
                  </div>
                ...
                <p>
                  Stop manually sending the MLS link to everyone who asks
                  "Price?".
                </p>
                <p>
                  Set up a keyword trigger:{' '}
                  <em>
                    "Comment <strong>123MAIN</strong> for price, photos, and
                    floorplan."
                  </em>
                </p>
                <p>
                  When they comment, your bot sends the full listing card
                  instantly.
                </p>
                ...
                <p>
                  Don't waste time on tire kickers. Let the bot filter them for
                  you.
                </p>
                <div className='bg-muted/50 p-6 rounded-lg border my-6 font-mono text-sm'>
                  ...
                  <p>
                    <strong>Bot:</strong> "Thanks for your interest in 123 Main
                    St! 🏡 Are you currently working with an agent?"
                  </p>
                  <p className='ml-4 text-muted-foreground'>[Yes] [No]</p>
                  <p className='mt-4'>
                    <strong>Bot:</strong> "Great. When are you looking to move?"
                  </p>
                  <p className='ml-4 text-muted-foreground'>
                    [ASAP] [1-3 Months] [Just Looking]
                  </p>
                  <p className='mt-4'>
                    <strong>Bot:</strong> "Perfect. Want to schedule a private
                    tour?"
                  </p>
                </div>
                ...
                <p>
                  If they qualify (e.g., Not working with an agent, Moving
                  ASAP), the bot sends your Calendly link. If they don't, the
                  bot tags them as "Nurture" and sends them your newsletter.
                </p>
                ...
                <Card className='my-12 bg-primary/5 border-primary/20'>
                  ...
                  <CardContent>
                    <p className='mb-6 text-muted-foreground'>
                      PostEngage.ai helps you capture every lead from your
                      listings. Try it free for 14 days.
                    </p>
