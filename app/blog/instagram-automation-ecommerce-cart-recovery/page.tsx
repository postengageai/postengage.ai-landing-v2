...
export const metadata: Metadata = {
  title: 'Instagram DM Cart Recovery Automation: Win Back Abandoned Cart Customers | PostEngage Blog',
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Instagram DM Cart Recovery Automation: Win Back Abandoned Cart Customers</h1>
              <p className="text-xl text-gray-600 mb-6">Abandoned carts are not lost sales — they are warm leads. Here is how to use Instagram DM automation to recover them.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="Instagram DM Cart Recovery Automation: Win Back Abandoned Cart Customers" /></div>
            </aside>
          </div>
        </div>
      </main>
