...
export const metadata: Metadata = {
  ...
  description: 'E-commerce brands receive hundreds of DMs a day about shipping, returns, and sizing. Here is how to set up an AI bot that handles 80% of support tickets automatically.',
  openGraph: {
    title: 'Using an Instagram AI Bot for Customer Service: Complete Setup Guide',
    description: 'E-commerce brands receive hundreds of DMs a day about shipping, returns, and sizing. Here is how to set up an AI bot that handles 80% of support tickets automatically.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-bot-customer-service',
    images: [{ url: '/blog/instagram-bot-customer-service-cover.png', width: 1200, height: 630, alt: 'Using an Instagram AI Bot for Customer Service: Complete Setup Guide' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Using an Instagram AI Bot for Customer Service: Complete Setup Guide',
    description: 'E-commerce brands receive hundreds of DMs a day about shipping, returns, and sizing. Here is how to set up an AI bot that handles 80% of support tickets automatically.',
    images: ['/blog/instagram-bot-customer-service-cover.png'],
  },
};
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-12'>
            <aside className='hidden lg:block lg:col-span-3 lg:sticky lg:top-32 lg:self-start space-y-8'>
              <div className='flex items-center gap-2 text-sm text-muted-foreground mb-4'>
                ...
                <span>/</span>
                <span className='text-foreground font-medium'>Customer Service</span>
              </div>
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Using an Instagram AI Bot for Customer Service: Complete Setup Guide
                </h1>
              ...
              <div className='relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-12 bg-muted'>
                <div className='absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white'>
                  <div className='text-center p-8'>
                    ...
                    <p className='text-xl font-medium text-white/80'>Customer Service</p>
                  </div>
                </div>
              </div>

              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                E-commerce brands receive hundreds of DMs a day about shipping, returns, and sizing. Here is how to set up an AI bot that handles 80% of support tickets automatically. This guide covers everything you need to know to get started and see results quickly.
              </div>
              ...
              >
                Why Customer Service on Instagram Matters in 2026
              </h2>
              <p>Instagram has over 2 billion monthly active users, and direct engagement through DMs and comments has never been higher. For customer service professionals and businesses, the platform represents an unmatched opportunity to reach qualified prospects where they are already spending time.</p>
