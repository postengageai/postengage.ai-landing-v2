...
export const metadata: Metadata = {
  title: 'Instagram Automation for Cleaning Services: Turn Before/After Photos Into Booked Jobs | PostEngage Blog',
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Instagram Automation for Cleaning Services: Turn Before/After Photos Into Booked Jobs</h1>
              <p className="text-xl text-gray-600 mb-6">Cleaning companies that automate Instagram DMs book more jobs per month with less effort. Here is the complete system.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="Instagram Automation for Cleaning Services: Turn Before/After Photos Into Booked Jobs" /></div>
            </aside>
          </div>
        </div>
      </main>
