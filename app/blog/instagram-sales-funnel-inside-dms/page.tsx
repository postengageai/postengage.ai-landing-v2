...
export const metadata: Metadata = {
  ...
  description: 'Top, middle, and bottom of funnel — all inside the DM inbox. Here is how to architect an Instagram DM funnel that closes sales without a website.',
  openGraph: {
    title: 'Building a Full Sales Funnel Inside Instagram DMs',
    description: 'Top, middle, and bottom of funnel — all inside the DM inbox. Here is how to architect an Instagram DM funnel that closes sales without a website.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-sales-funnel-inside-dms',
    images: [{ url: '/blog/instagram-sales-funnel-inside-dms-cover.png', width: 1200, height: 630, alt: 'Building a Full Sales Funnel Inside Instagram DMs' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Building a Full Sales Funnel Inside Instagram DMs',
    description: 'Top, middle, and bottom of funnel — all inside the DM inbox. Here is how to architect an Instagram DM funnel that closes sales without a website.',
    images: ['/blog/instagram-sales-funnel-inside-dms-cover.png'],
  },
};
          ...
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-12'>
            <aside className='hidden lg:block lg:col-span-3 lg:sticky lg:top-32 lg:self-start space-y-8'>
              <div className='flex items-center gap-2 text-sm text-muted-foreground mb-4'>
                ...
                <span>/</span>
                <span className='text-foreground font-medium'>Funnels</span>
              </div>
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Building a Full Sales Funnel Inside Instagram DMs
                </h1>
              ...
              <div className='relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-12 bg-muted'>
                <div className='absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white'>
                  <div className='text-center p-8'>
                    ...
                    <p className='text-xl font-medium text-white/80'>Funnels</p>
                  </div>
                </div>
              </div>

              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Top, middle, and bottom of funnel — all inside the DM inbox. Here is how to architect an Instagram DM funnel that closes sales without a website. This guide covers everything you need to know to get started and see results quickly.
              </div>
              ...
              >
                Why Funnels on Instagram Matters in 2026
              </h2>
              <p>Instagram has over 2 billion monthly active users, and direct engagement through DMs and comments has never been higher. For funnels professionals and businesses, the platform represents an unmatched opportunity to reach qualified prospects where they are already spending time.</p>
