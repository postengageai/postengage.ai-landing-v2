...
export const metadata: Metadata = {
  ...
  description: 'Generic chatbot replies kill trust. Learn how to feed your AI bot your brand voice so every reply sounds authentically human.',
  openGraph: {
    title: 'Instagram AI Replies: How to Train Your Bot to Sound Like You',
    description: 'Generic chatbot replies kill trust. Learn how to feed your AI bot your brand voice so every reply sounds authentically human.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-ai-replies-train-your-bot',
    images: [{ url: '/blog/instagram-ai-replies-train-your-bot-cover.png', width: 1200, height: 630, alt: 'Instagram AI Replies: How to Train Your Bot to Sound Like You' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Instagram AI Replies: How to Train Your Bot to Sound Like You',
    description: 'Generic chatbot replies kill trust. Learn how to feed your AI bot your brand voice so every reply sounds authentically human.',
    images: ['/blog/instagram-ai-replies-train-your-bot-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  Instagram AI Replies: How to Train Your Bot to Sound Like You
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Generic chatbot replies kill trust. Learn how to feed your AI bot your brand voice so every reply sounds authentically human. This guide covers everything you need to know to get started and see results quickly.
              </div>
