...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background font-sans antialiased'>
      <ArticleJsonLd
        title='Slash Customer Support Response Time by 80% on Instagram'
        description='Customers expect a reply in 5 minutes. Learn how to use AI and automation to deliver 24/7 support without hiring more staff.'
        slug='customer-support-automation-24-7'
        datePublished='2026-03-23'
        category='Blog'
      />
