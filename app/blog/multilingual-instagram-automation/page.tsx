  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        ...
        description='Your audience speaks multiple languages, but your automation only speaks one. Learn how to set up multilingual DM sequences that feel local to every follower.'
