...
export const metadata: Metadata = {
  title: 'Instagram DM Automation for Recruiters: Find and Engage Top Talent Where They Are | PostEngage Blog',
...
export default function BlogPost() {
  const tocItems = [
    { id: 'why-it-matters', title: 'Why Instagram DM Automation Matters for HR' },
        ...
        <div className="bg-linear-to-b from-violet-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-3xl mx-auto text-center">
              <Badge className="mb-4 bg-violet-100 text-violet-700 hover:bg-violet-100">HR</Badge>
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Instagram DM Automation for Recruiters: Find and Engage Top Talent Where They Are</h1>
              <p className="text-xl text-gray-600 mb-6">The best candidates are not always actively job hunting. Recruiters using Instagram automation find passive candidates others miss.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section id="conversion-strategies" className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Conversion Strategies That Work</h2>
              ...
              <div className="bg-violet-50 border border-violet-200 rounded-xl p-6 my-6">
                <h3 className="font-bold text-violet-900 mb-3">HR DM Automation Quick Start</h3>
          ...
          <section id="measuring-success" className="mb-12">
            ...
            <aside className="hidden lg:block lg:col-span-2">
              <div className="sticky top-24"><SocialShareButtons title="Instagram DM Automation for Recruiters: Find and Engage Top Talent Where They Are" /></div>
            </aside>
          </div>
        </div>
      </main>
