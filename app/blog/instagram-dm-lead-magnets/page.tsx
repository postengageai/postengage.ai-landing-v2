...
export const metadata: Metadata = {
  ...
  description: 'Free checklists, templates, discount codes, early access — these are the DM lead magnets that make people comment and hand over their email without hesitation.',
  openGraph: {
    title: '10 Instagram DM Lead Magnets That Convert Like Crazy',
    description: 'Free checklists, templates, discount codes, early access — these are the DM lead magnets that make people comment and hand over their email without hesitation.',
    type: 'article',
    url: 'https://postengage.ai/blog/instagram-dm-lead-magnets',
    images: [{ url: '/blog/instagram-dm-lead-magnets-cover.png', width: 1200, height: 630, alt: '10 Instagram DM Lead Magnets That Convert Like Crazy' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: '10 Instagram DM Lead Magnets That Convert Like Crazy',
    description: 'Free checklists, templates, discount codes, early access — these are the DM lead magnets that make people comment and hand over their email without hesitation.',
    images: ['/blog/instagram-dm-lead-magnets-cover.png'],
  },
};
            ...
            <article className='lg:col-span-7 prose prose-lg dark:prose-invert max-w-none'>
              <header className='mb-12 not-prose'>
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight'>
                  10 Instagram DM Lead Magnets That Convert Like Crazy
                </h1>
              ...
              <div className='lead text-xl text-muted-foreground mb-12 leading-relaxed'>
                Free checklists, templates, discount codes, early access — these are the DM lead magnets that make people comment and hand over their email without hesitation. This guide covers everything you need to know to get started and see results quickly.
              </div>
