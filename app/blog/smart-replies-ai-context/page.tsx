...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='Introducing Smart Replies: AI Context Awareness'
        description='Our new AI engine understands context better than ever before. Learn how it can save you 10+ hours a week by generating human-like responses.'
