...
export default function BlogPost() {
  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      <ArticleJsonLd
        title='High-Ticket Sales: Selling $5k+ Coaching Programs in DMs'
        description='Stop chasing low-ticket sales. Learn how to use automated qualification to fill your calendar with high-value coaching prospects.'
      ...
      <main className='flex-1'>
        ...
        <article className='container mx-auto max-w-7xl px-4 py-12 md:py-24'>
          ...
          <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border shadow-sm bg-gradient-to-br from-fuchsia-500/20 via-pink-500/10 to-rose-500/5'>
            <div className='absolute inset-0 flex flex-col items-center justify-center gap-4'>
              <div className='flex h-16 w-16 items-center justify-center rounded-2xl bg-background/60 border border-border/40 shadow-inner'>
                <Gem className='h-8 w-8 text-primary/70' />
              </div>
              <div className='flex items-center gap-2'>
