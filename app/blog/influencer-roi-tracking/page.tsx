...
export default function BlogPostPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground font-sans selection:bg-primary/20'>
      <ArticleJsonLd
        title='Influencer ROI Tracking: The Missing Link in Your Campaigns'
        description='Stop guessing if your influencers are driving sales. Use DM automation to track every click, conversation, and conversion with 100% accuracy.'
              ...
              <div className='relative mx-auto mb-16 aspect-[21/9] max-w-5xl overflow-hidden rounded-2xl border shadow-sm bg-gradient-to-br from-primary/20 via-primary/10 to-muted/20'>
                <div className='absolute inset-0 flex flex-col items-center justify-center gap-4'>
                  <div className='flex h-16 w-16 items-center justify-center rounded-2xl bg-background/60 border border-border/40 shadow-inner'>
                    <PieChart className='h-8 w-8 text-primary/70' />
                  </div>
