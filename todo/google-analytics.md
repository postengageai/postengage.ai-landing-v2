...
- [x] **Event**: Submit Newsletter Form (`footer_newsletter_submit`) (Not applicable: Feature not present)
...
- [x] **Event**: Exit Intent Detected (`exit_intent_triggered`)
- [x] **Event**: Close Popup (`exit_intent_popup_close`)
- [x] **Event**: Submit Email (`exit_intent_popup_email_submit`) (Not applicable: Feature not present)
...
- [x] **Event**: Hover Creator Avatar (`creator_avatar_hover`) (Not applicable: Section displays brands, not avatars)
- [x] **Event**: View Stats Counter (`stats_counter_view`) (Not applicable: Section displays brands)
...
- [x] **Event**: View Metric (`testimonial_metric_view`) (Included in card view)
...
- [x] **Event**: Use Credit Calculator (`pricing_credit_calculator_use`) (Not applicable: Calculator not implemented)
- [x] **Event**: Expand Pricing FAQ (`pricing_faq_expand`) (Covered by main FAQ section)
- [x] **Event**: Click Pricing CTA (`pricing_cta_click`) (Same as select plan)
...
- [x] **Event**: Features Page View (`features_page_view`) (Handled by `PageViewTracker`)
- [x] **Event**: About Page View (`about_page_view`) (Handled by `PageViewTracker`)
...
### Scroll Events
- [x] **Event**: Scroll 25% (`scroll_25_percent`)
- [x] **Event**: Scroll 50% (`scroll_50_percent`)
- [x] **Event**: Scroll 75% (`scroll_75_percent`)
- [x] **Event**: Scroll 100% (`scroll_100_percent`)

### Engagement Events
- [x] **Event**: Time on Page 30s (`time_on_page_30s`)
- [x] **Event**: Time on Page 60s (`time_on_page_60s`)
- [x] **Event**: Time on Page 120s (`time_on_page_120s`)
- [x] **Event**: Time on Page 300s (`time_on_page_300s`)
